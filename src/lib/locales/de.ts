...
export const de: TranslationStrings = {
  stepUpload: 'Foto hochladen',
  stepProcessing: 'Ihr Raum wird transformiert...',
  stepResult: 'Ihr neues Zimmer ansehen',
  stepIndicatorUpload: 'Hochladen',
  stepIndicatorProcessing: 'Verarbeitung',
  stepIndicatorResult: 'Ergebnis',
  launchButton: 'In Ihrem Raum visualisieren',
  ...
  loadingMessages: [
    ...
    'Produkt wird auf den Boden skaliert...',
    'Neuronale Texturen werden angewendet...',
    'Fotorealistisches Rendering wird abgeschlossen...',
  ],
  ...
  disclaimer: 'Das Bild ist eine Schätzung. Miss zu Hause nach, bevor du kaufst.',
  downloadedStatus: 'Bild heruntergeladen.',
