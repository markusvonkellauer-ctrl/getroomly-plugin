...
export const zh: TranslationStrings = {
  ...
  tip1Label: '角度：',
  tip1Body: '在1-2米距离处拍摄，画面中保留家具以作比例参考。',
  tip2Label: '光线：',
  tip2Body: '确保房间明亮，避免出现深阴影。',
  tip3Label: '空出地面：',
  tip3Body: '清除地毯将要放置区域的物品。',
  termsLink: '使用条款与隐私政策',
  loadingMessages: [
    '正在分析房间几何结构...',
    '正在检测环境光线...',
  ...
  labelNew: '新设计',
  addToBasket: '加入购物车',
  addedToBasketLabel: '已加入 ✓',
  addedToBasketAnnouncement: '产品已加入购物车。',
  toggleBefore: '之前',
  toggleAfter: '之后',
  toggleGroupLabel: '显示房间的前后对比',
  feedbackQuestion: '看起来真实吗？',
  feedbackThanks: '感谢您的反馈。',
  feedbackLikeLabel: '是的，看起来很真实',
  feedbackDislikeLabel: '不，看起来不真实',
  favoriteLabel: '添加到收藏',
  favoriteLabelActive: '已添加到收藏',
  disclaimer: '图片仅供参考。购买前请在家中测量。',
  downloadToDevice: '下载图片',
  downloadedLabel: '已下载 ✓',
