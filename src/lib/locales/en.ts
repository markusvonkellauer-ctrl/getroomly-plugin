...
export const en: TranslationStrings = {
  ...
  addedToBasketAnnouncement: 'The product has been added to your basket.',
  toggleBefore: 'Before',
  toggleAfter: 'After',
  toggleGroupLabel: 'Show the room before or after',
  feedbackQuestion: 'Does it look realistic?',
  feedbackThanks: 'Thanks for your feedback.',
  feedbackLikeLabel: 'Yes, it looks realistic',
  feedbackDislikeLabel: "No, it doesn't look realistic",
  favoriteLabel: 'Save to favourites',
  favoriteLabelActive: 'Saved to favourites',
  disclaimer: 'The image is an estimate. Measure at home before you buy.',
