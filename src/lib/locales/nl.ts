...
export const nl: TranslationStrings = {
  ...
  tip1Label: 'Hoek:',
  tip1Body: 'Fotografeer vanaf 1–2 meter afstand. Laat gerust meubels in beeld voor de schaal.',
  tip2Label: 'Licht:',
  tip2Body: 'Zorg dat de kamer licht is en vermijd diepe schaduwen.',
  tip3Label: 'Vrije vloer:',
  tip3Body: 'Verwijder spullen van het oppervlak waar het tapijt geplaatst wordt.',
