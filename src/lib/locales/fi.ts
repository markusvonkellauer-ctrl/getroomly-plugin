...
export const fi: TranslationStrings = {
  ...
  tip1Label: 'Kuvakulma & etäisyys:',
  tip1Body:
    'Seiso 1–2 metrin päässä ja suuntaa kamera kohti lattiaa. Ota huonekalut mukaan mittakaavan vuoksi.',
  tip2Label: 'Valaistus:',
  tip2Body: 'Varmista, että huone on hyvin valaistu. Vältä syviä varjoja tai pimeitä nurkkia.',
  tip3Label: 'Tyhjä lattia-alue:',
  tip3Body: 'Poista pienet tavarat lattia-alueelta, johon matto sijoitetaan.',
