...
export const da: TranslationStrings = {
  ...
  addedToBasketLabel: 'Tilføjet ✓',
  addedToBasketAnnouncement: 'Produktet er tilføjet til kurven.',
  toggleBefore: 'Før',
  toggleAfter: 'Efter',
  toggleGroupLabel: 'Vis rummet før eller efter',
  feedbackQuestion: 'Ser det realistisk ud?',
  feedbackThanks: 'Tak for din feedback.',
  feedbackLikeLabel: 'Ja, det ser realistisk ud',
  feedbackDislikeLabel: 'Nej, det ser ikke realistisk ud',
  favoriteLabel: 'Gem som favorit',
  favoriteLabelActive: 'Gemt som favorit',
  disclaimer: 'Billedet er et estimat. Mål derhjemme, før du køber.',
