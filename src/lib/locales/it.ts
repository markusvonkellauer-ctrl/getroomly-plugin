...
export const it: TranslationStrings = {
  ...
  tip1Label: 'Angolo:',
  tip1Body:
    'Fotografa da una distanza di 1–2 metri. Lascia i mobili visibili come riferimento per la scala.',
  tip2Label: 'Luce:',
  tip2Body: 'Assicurati che la stanza sia luminosa ed evita le ombre profonde.',
  ...
  addedToBasketLabel: 'Aggiunto ✓',
  addedToBasketAnnouncement: 'Il prodotto è stato aggiunto al carrello.',
  toggleBefore: 'Prima',
  toggleAfter: 'Dopo',
